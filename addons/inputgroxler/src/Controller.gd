...
static func _get_motion_vector_from_device(neg_x, pos_x, neg_y, pos_y) -> Vector2:
...
class KeyboardMouse extends GroxledController:
...
class Joypad extends GroxledController:
